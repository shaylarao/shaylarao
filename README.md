...
* Software: Jira, Insomnia, Zapier, Linear, NetSuite, Confluence, GitHub, Lucidchart, Zendesk, Salesforce, HubSpot, AWS, Azure, GCP, Tableau, PowerBI, FHIR, HIPAA, EMR/EHR Systems
* Technical: Python, SQL, TensorFlow, REST APIs, OAuth, Webhooks, JavaScript, Java, C, C++
* Certificates: Google AI Essentials, Google Data Analytics Certificate, Google Project Management Certificate
